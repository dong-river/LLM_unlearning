...
#     'eval_num': eval_num,
#     'lr_su': [1e-8], #'lr_su': [1e-6, 1e-7, 1e-8],
#     'su_strength': [3, 10],
...
#     'eval_batch_size': eval_batch_size,
#     'eval_num': eval_num,
#     'lr_su': [1e-5, 1e-4], #'lr_su': [1e-6, 1e-7, 1e-8], 
#     'su_strength': [3, 10],
#     'num_epochs_su': [1, 2, 3, 10, 30],
#     'peft': 'lora',
#     'output_folder': 'outputs_new'
...
dic_list = {"su_dic": su_dic}
# dic_list = {"su_2_lora": su_dic_2_lora, "su_2": su_dic_2}
...
for idx in range(1 + len(all_commands) // num_commands_per_file):
    ...
    output_path = f'exp_su_1.3B_lora_{idx}.slurm'
